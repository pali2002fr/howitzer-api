...
class Shot extends AbstractEntity implements ShotInterface
{
    ...
    public function __construct( UserInterface $user, HowitzerInterface $howitzer, TargetInterface $target, DistanceInterface $distance, SpeedInterface $speed, AngleInterface $angle) {
